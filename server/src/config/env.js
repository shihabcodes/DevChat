...
function getEnv() {
    ...
    const env = {
        ...
        IS_PROD: isProd,
        MONGODB_URI: process.env.MONGODB_URI || 'mongodb://127.0.0.1:27017/devchat',
        JWT_SECRET: process.env.JWT_SECRET || 'devchat_dev_secret_change_in_production_minimum_64_chars_required',
        CLIENT_URL: process.env.CLIENT_URL || DEFAULT_CLIENT_URL,
        ALLOWED_ORIGINS: parseAllowedOrigins(),
        OPENAI_KEY_ENCRYPTION_SECRET:
            process.env.OPENAI_KEY_ENCRYPTION_SECRET || 'devchat_dev_openai_key_encryption_secret_32bytes_min_xx',
